...
if __name__ == '__main__':
    ...
    weights_path = '/gpfs/data/denizlab/Users/bz1030/model/model_weights/from_scratch/train_from_scratch_randC2'
    print('Load model ...')
    resnet34 = load_model(weights_path + '/resnet34_from_scratch_randCrop_checkpoint_120000.h5')
