...
parser.add_argument('-attn','--attn',help='attention types CBAM or BAM')

if __name__ == '__main__':
    args = parser.parse_args()
    job_number = str(args.model)
    ...
    log_file_path = '/gpfs/data/denizlab/Users/bz1030/KneeNet/KneeProject/model/model_torch/model_new_preprocessing/train_{}_log{}'.format(
        attn, job_number)
    model_file_path = '/gpfs/data/denizlab/Users/bz1030/KneeNet/KneeProject/model/model_torch/model_new_preprocessing/model_{}_weights{}'.format(
        attn, job_number)
    output_file_path = '/gpfs/data/denizlab/Users/bz1030/KneeNet/KneeProject/model/model_torch/model_new_preprocessing/train_{}_log{}/output{}.txt' \
