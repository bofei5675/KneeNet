...
if __name__ == '__main__':
    ...
    model_file_path ='/gpfs/data/denizlab/Users/bz1030/KneeNet/KneeProject/model/model_torch/model_new_preprocessing/model_MSE_weights1/epoch_18.pth'
    ...
    test_loss, probs, truth, _ = validate_epoch(model, test_loader, criterion,use_cuda = USE_CUDA,loss_type ='MSE')
    preds = probs
    # Validation metrics
